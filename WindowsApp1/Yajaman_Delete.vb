...
Public Class Yajaman_Delete
    ...
    Private Sub Btn_Save_Click(sender As Object, e As EventArgs) Handles Btn_Save.Click
        ...
        cmd.CommandText = "Update યજમાન Set Yajaman_Name='" + Txt_Name.Text + "' , Surname='" + Txt_SurName.Text + "', `Fathers Name`='" + Txt_Fathers_Name.Text + "', `Contac No`='" + Txt_Contact.Text + "', `Phone No`='" + Txt_Phone.Text + "', Address='" + Txt_Address.Text + "', `Email Id`='" + Txt_Mail.Text + "', Other_Details='" + Txt_Detail.Text + "' Where ID=" & IDS.Item(index) & ";"
    ...
    Private Sub Yajaman_Delete_Load(sender As Object, e As EventArgs) Handles Me.Load
        cmd.Connection = con
        Txt_Detail.Text = ""
        ...
        Try
            ...
            cmd.CommandText = "Select * from યજમાન Where ID=" & IDS.Item(0) & ";"
            dr = cmd.ExecuteReader()
            ...
            With dr
                If (.Read()) Then
                    ...
                    If Not .IsDBNull(5) Then
                        Txt_Phone.Text = .GetValue(5)
                    End If

                    If Not .IsDBNull(6) Then
                        Txt_Mail.Text = .GetValue(6)
                    End If
            ...
            cmd.CommandText = "Select Count(*) From યજમાન;"
    ...
    Private Sub Yajaman_Delete_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        Form1.Enabled = True
    End Sub
            ...
            Try
                ...
                With dr
                    If (.Read()) Then
                        ...
                        Txt_Phone.Text = s1(6)
                        Txt_Mail.Text = s1(7)
                        Txt_Address.Text = s1(8)
                        Txt_Detail.Text = s1(9)
    ...
    Private Sub Btn_Pre_Click(sender As Object, e As EventArgs) Handles Btn_Pre.Click
        If index > -1 Then
            ...
            cmd.CommandText = "Select * from યજમાન Where ID=" & IDS.Item(index) & ";"
    ...
    Private Sub Btn_Lst_Click(sender As Object, e As EventArgs) Handles Btn_Lst.Click
        index = IDS.Count - 1
        Txt_Detail.Text = ""
        cmd.CommandText = "Select * from યજમાન Where ID=" & IDS.Item(IDS.Count - 1) & ";"
    ...
    Private Sub Btn_Del_Click(sender As Object, e As EventArgs) Handles Btn_Del.Click
        ...
        cmd.CommandText = "Delete From યજમાન Where ID=" + Lbl_Id.Text.Trim() + ";"
